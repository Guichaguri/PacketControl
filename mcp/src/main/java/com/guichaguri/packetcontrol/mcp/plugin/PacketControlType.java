...
public class PacketControlType<T extends Packet, A> implements PacketType<T, A> {
    ...
    private final PacketPhase phase;
    ...
    public PacketControlType(String id, String name, PacketSide side, PacketPhase phase, Class<? extends net.minecraft.network.Packet> clazz, PacketFactory<T, A> factory) {
        this.id = id;
        this.name = name;
        this.side = side;
        this.phase = phase;
