...
public class PacketRegistryModule implements ExtraClassCatalogRegistryModule<PacketType, Packet>, SpongeAdditionalCatalogRegistryModule<PacketType> {
    ...
    void serverbound(String id, String name, Class<? extends Packet> clazz) {
        register(id, name, PacketSide.SERVERBOUND, PacketPhase.PLAY, clazz, null);
    }

    void clientbound(String id, String name, Class<? extends Packet> clazz) {
        register(id, name, PacketSide.CLIENTBOUND, PacketPhase.PLAY, clazz, null);
    }
    ...
    void clientbound(String id, String name, Class<? extends Packet> clazz, PacketFactory<P, A> factory) {
        register(id, name, PacketSide.CLIENTBOUND, PacketPhase.PLAY, clazz, factory);
    }

    void register(String id, String name, PacketSide side, PacketPhase phase, Class<? extends Packet> packetClass) {
        register(id, name, side, phase, packetClass, null);
    }

    <P extends com.guichaguri.packetcontrol.api.Packet, A>
    void register(String id, String name, PacketSide side, PacketPhase phase, Class<? extends Packet> packetClass, PacketFactory<P, A> factory) {
        PacketControlType<P, A> type = new PacketControlType<>(id, name, side, phase, packetClass, factory);
